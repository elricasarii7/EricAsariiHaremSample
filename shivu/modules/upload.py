...
rarity_map = 1 (⚪️ Common), 2 (🟢 Medium) , 3 (🟣 Rare), 4 (🟡 Legendary)"""
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟢 Medium", 3: "🟣 Rare", 4: "🟡 Legendary"}
        try:
...
async def update(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        if args[1] in ['name', 'anime']:
            ...
            rarity_map = {1: "⚪ Common", 2: "🟢 Medium", 3: "🟣 Rare", 4: "🟡 Legendary", 5: "💮 Special edition"}
            try:
