...
rarity_map = 1 (⚪️ Common), 2 (🟢 Medium) , 3 (🟣 Rare), 4 (🟡 Legendary), 5 (🔮 Mythical), 6 (❄️ Limited edition) 7 (💮 Special edition), 8 (💞 Couple edition), 9 (🫧 Super unique)"""
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟢 Medium", 3: "🟣 Rare", 4: "🟡 Legendary", 5: "🔮 Mythical", 6: "❄️ Limited edition", 7: "💮 Special edition", 8: "💞 Couple edition", 9: "🫧 Super unique"}
        try:
